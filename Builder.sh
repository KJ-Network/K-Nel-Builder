...
if [ $option = 1 ]
    ...
    if [ $device = 2 ]
        then 
        cd ./Sources/Mido/
        bash build-kernel.sh | tee /root/K-Nel-Projects/OutFiles/Build-Kernel-Mido.log
        if [ -e '/root/K-Nel-Projects/OutFiles/K-Nel-Mido.zip' ]
          then rm '/root/K-Nel-Projects/OutFiles/K-Nel-Mido.zip'
        fi
        ...
        then
            ...
            zip -r '/root/K-Nel-Projects/OutFiles/K-Nel-Mido.zip' *
        else
        echo 'Build Failed!'
        exit
        fi
        if [ -s '/root/K-Nel-Projects/OutFiles/K-Nel-Mido.zip' ]
